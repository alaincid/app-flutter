    ...
    try {
      if (json != null && json[attribute] != null) {
        if (json[attribute] is Map<String, dynamic>) {
          if (json[attribute][defaultLocale ?? Get.locale.languageCode] == null) {
            return json[attribute][Get.find<TranslationService>().fallbackLocale.languageCode].toString();
          } else {
            return json[attribute][defaultLocale ?? Get.locale.languageCode];
          }
        } else {
